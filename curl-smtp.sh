...
--mail-from mailtrap@nbrinton.dev \
--mail-rcpt nab.natethegreat@gmail.com \
--upload-file - <<EOF
From: Magic Elves <mailtrap@nbrinton.dev>
To: Mailtrap Inbox <nab.natethegreat@gmail.com>
